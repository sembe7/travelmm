        ...
        <?php if($row->duration): ?>
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    ...
                    <div class="info">
                        <h4 class="name"><?php echo e(__("Date")); ?></h4>
                        <p class="value">
                            <?php if($row->duration > 1): ?>
                                <?php echo e(__(":start  :End",array('start'=>$row->tourStart,'End'=>$row->tourEnd))); ?>
...
<?php if($row->days): ?>
<div class="g-faq">
    <h3> <?php echo e(__("Аяллын өдрүүд")); ?> </h3>
    <?php $__currentLoopData = $row->days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="item">
            <div class="header">
                
                <i class="field-icon icofont-paper-plane"></i>
                <h5><?php echo e($item['day']); ?></h5>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\travel\modules/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>